...
class Paginacion{
    ...
    //mostrar cantidad de registros en cada pagina
    public function offset(){
        return $this->registros_por_pagina * ($this->pagina_actual - 1);
    }

    //generar cantidad de paginas
